 ...
 int charty;
  ...
  void drawPoints() {
    ...
    while (it.hasNext ()) {
      ...
      if(t.ailment.equals("sick")){
        fill(#9BFFFF, t.lifespan);
        ccCount += 1;
        charty = ccCount/10;
        rect(850,(300- charty),20,charty,5,0);
        ...
        fluCount+=1;
        charty = fluCount/10;
        rect(900,(300- charty),20,charty,5,0);
      } 
       // else if(t.ailment.equals("sorethroat")){
        //fill(#1CCB4B, t.lifespan);
        //stCount+=1;
        //charty = stCount/10;
       // rect(950,(300- charty),20,charty,5,0);
     // }
      else if(t.ailment.equals("man flu")){
     ...
     // else if(t.ailment.equals("cough")){
      //  fill(#4719C5, t.lifespan);
       // cofCount+=1;
     //   charty = cofCount/10;
       // rect(1050,(300- charty),20,charty,5,0);
      //}
