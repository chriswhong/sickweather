...
void setup() {
  ...
  mapImage = loadImage("usa.png");
  logo = loadImage("logo.png");
  mercatorMap = new MercatorMap(1280, 720, 
  53.365, 20.295, -137.483, -61.307);
  legendFont = createFont("HelveticaNeue-Bold", 24);
  legendFont2 = createFont("HelveticaNeue-Light", 24);
    legendFont3 = createFont("HelveticaNeue-Light", 65);
    legendFont4 = createFont("HelveticaNeue-Light", 45);
       legendFont5 = createFont("HelveticaNeue-Light", 160);
 //tint(100 , 100, 100);
